...
IMAGE_SET = UploadSet("images", IMAGES)  # Set name and allowed file extensions


def save_image(image: FileStorage, folder: str = None, name: str = None) -> str:
    """ Takes FileStorage object and saves it to a folder"""
    return IMAGE_SET.save(image, folder, name)


def get_path(filename: str = None, folder: str = None) -> str:
    """Takes image name and folder and returns the full path"""
...
def _retrieve_filename(file: Union[str, FileStorage]) -> str:
    """ Take FileStorage or string and return the file name """
